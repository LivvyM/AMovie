...
public class SettingActivity extends AppBaseActivity{
    ...
    private DataResult initData(){
        ...
        dataItem.setString("content","AAA1");
        result.addItem(dataItem);
        dataItem = new DataItem();
        dataItem.setString("content","AAA2");
        result.addItem(dataItem);
        dataItem = new DataItem();
        dataItem.setString("content","AAA3");
        result.addItem(dataItem);
        dataItem = new DataItem();
        dataItem.setString("content","AAA4");
        result.addItem(dataItem);
        dataItem = new DataItem();
        dataItem.setString("content","AAA5");
        result.addItem(dataItem);
        dataItem = new DataItem();
        dataItem.setString("content","AAA6");
        result.addItem(dataItem);
        dataItem = new DataItem();
        dataItem.setString("content","AAA7");
        result.addItem(dataItem);

        dataItem = new DataItem();
        dataItem.setString("content","BBB1");
        result.addItem(dataItem);
        dataItem = new DataItem();
        dataItem.setString("content","BBB2");
        result.addItem(dataItem);
        dataItem = new DataItem();
        dataItem.setString("content","BBB3");
        result.addItem(dataItem);
        dataItem = new DataItem();
        dataItem.setString("content","BBB4");
        result.addItem(dataItem);
        dataItem = new DataItem();
        dataItem.setString("content","BBB5");
        result.addItem(dataItem);
        dataItem = new DataItem();
        dataItem.setString("content","BBB6");
        result.addItem(dataItem);
        dataItem = new DataItem();
        dataItem.setString("content","BBB7");
        result.addItem(dataItem);

        dataItem = new DataItem();
        dataItem.setString("content","CCC1");
        result.addItem(dataItem);
        dataItem = new DataItem();
        dataItem.setString("content","CCC2");
        result.addItem(dataItem);
        dataItem = new DataItem();
        dataItem.setString("content","CCC3");
        result.addItem(dataItem);
        dataItem = new DataItem();
        dataItem.setString("content","CCC4");
        result.addItem(dataItem);
        dataItem = new DataItem();
        dataItem.setString("content","CCC5");
        result.addItem(dataItem);
        dataItem = new DataItem();
        dataItem.setString("content","CCC6");
        result.addItem(dataItem);
